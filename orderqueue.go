...
func getOrdersFromQueue() ([]Order, error) {
	...
	console.log("Donna order queue name: " + orderQueueName);
	if orderQueueName == "" {
	...
	console.log("Donna: workload identity: " + useWorkloadIdentityAuth);
	...
	if orderQueueHostName != "" && useWorkloadIdentityAuth == "true" {
		...
		console.log("Donna: order_queue_password: " + orderQueuePassword);
